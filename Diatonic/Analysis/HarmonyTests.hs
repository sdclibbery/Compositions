...
testAnalyseHarmonyS96 = TestLabel "analyseHarmony S96" $ TestList
	...
	, test [Error (1%4) (Harmony 96) "Consecutive unisons"]		$ (i 4 qn :+: ii 4 qn) :=: (i 4 qn :+: ii 4 qn)
	, test []													$ (i 4 qn :+: i 4 qn) :=: (i 4 qn :+: i 4 qn)
	, test [Error (1%4) (Harmony 96) "Consecutive octaves"]		$ (i 3 qn :+: ii 3 qn) :=: (i 4 qn :+: ii 4 qn)
	, test []													$ (i 3 qn :+: i 3 qn) :=: (i 4 qn :+: i 4 qn)
	, test []													$ (rest en :+: i 4 qn :+: ii 4 qn) :=: (i 4 qn :+: ii 4 qn)
	, test [Error (1%1) (Harmony 96) "Consecutive unisons"]		$ (rest dhn :+: i 4 qn :+: ii 4 qn) :=: (i 4 wn :+: ii 4 wn)
	] where
		test e m = (show m) ~: e ~=? analyseMusic M.Major m
...
testToIntervalInfos = TestLabel "toIntervalInfos" $ TestList
	[ test []												[]
	, test []												[ (1, dti 4, dti 4) ]
	, test [(2, Similar, i8, i8)]							[ (1, dti 3, dti 4), (2, dtii 3, dtii 4) ]
	, test [(2, Similar, i2, i3)]							[ (1, dti 3, dtii 3), (2, dtii 3, dtiv 3) ]
	, test [(2, Oblique, iu, i3)]							[ (1, dtii 3, dtii 3), (2, dtii 3, dtiv 3) ]
	, test [(2, Contrary, iu, i8)]							[ (1, dtii 3, dtii 3), (2, dti 3, dti 4) ]
	, test [(2, Contrary, iu, i8), (3, Oblique, i8, i2)]	[ (1, dtii 3, dtii 3), (2, dti 3, dti 4), (3, dti 3, dtii 3) ]
	] where
